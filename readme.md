...
A smartHomeNG plugin and smartVISU widget to read out SAMSON TROVIS 557x Heating Automation Controllers.
...
Further details can be found at the [Wiki](https://github.com/Tom-Bom-badil/samson_trovis_557x/wiki) (German).
